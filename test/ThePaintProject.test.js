...
contract('ThePaintProject', (accounts) => {
    ...
    describe('metadata', async () => {
        ...
        const expectedTokenUri = 'data:application/json;base64,';
    ...
    //////////////////////////
    // NOTE: Add these tests to colorConverter??
    //////////////////////////
